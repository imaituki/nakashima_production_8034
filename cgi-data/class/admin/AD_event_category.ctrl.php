...
class AD_event_category {
	...
	// 主テーブル
	var $_CtrTable   = "t_event_category";
	...
	function check( &$arrVal, $mode ) {
		...
		if( ( strcmp( $mode, "update" ) == 0 ) ) {
			$objInputCheck->entryData( "カテゴリID", "all", $arrVal["id_event_category"], array( "CHECK_EMPTY", "CHECK_NUM" ), null, null );
		}
	...
	function update( $arrVal, $arrSql = null ) {
		...
		// 更新条件
		$where = $this->_CtrTablePk . " = " . $arrVal["id_event_category"];
