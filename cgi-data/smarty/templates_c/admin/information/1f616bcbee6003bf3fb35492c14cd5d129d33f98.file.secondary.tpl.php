<?php /* Smarty version Smarty-3.1.18, created on 2019-11-19 16:40:34
...
/contents/information/"><i class="fa fa-info-circle"></i><span class="nav-label">お知らせ管理</span></a></li>
			...
			<li<?php if ($_smarty_tpl->tpl_vars['manage']->value=="event") {?> class="active"<?php }?>>
...
/contents/event_category/">イベント・会場設営カテゴリ一覧</a></li>
			...
			<li<?php if ($_smarty_tpl->tpl_vars['manage']->value=="rental") {?> class="active"<?php }?>>
...
/contents/rental_category/">レンタル品カテゴリ一覧</a></li>
			...
			<li<?php if ($_smarty_tpl->tpl_vars['manage']->value=="talent") {?> class="active"<?php }?>>
