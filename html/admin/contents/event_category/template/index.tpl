...
<div id="wrapper">
	{include file=$template_secondary action="event" manage="event_category"}
					...
					<form method="post" action="" id="formSearch" enctype="multipart/form-data">
						<div class="col-sm-4">
							...
							<div class="input-group">
								<input type="text" id="search_keyword" name="search_keyword" value="{$_SESSION.admin.event_category.search.POST.search_keyword|default:""}" placeholder="キーワード" class="form-control">
